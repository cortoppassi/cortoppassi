...
<table align="center">
  <tr>
    <td>
      <ul>
        <li>🎓 Tecnólogo em <strong>Análise e Desenvolvimento de Sistemas</strong> - UNIFACS</li>
        <li>💼 Atuo como <strong>Desenvolvedor Full-Stack</strong> na <strong>SEIDOR</strong></li>
        <li>🤖 Trabalho com produto web e <strong>IA aplicada</strong></li>
        <li>📚 Buscando evolução constante em arquitetura, performance e boas práticas</li>
        <li>🎯 Foco atual: construir soluções mais limpas, escaláveis e úteis</li>
      </ul>
    </td>
    <td>
...
class DevStack {
  ...
  database = "MySQL";
  tools = "Docker / Jest / Git / GitHub";
  focus = "IA aplicada / arquitetura / performance";
}
