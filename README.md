...
Atualmente também estou aprofundando meus estudos em **Go**, com foco em backend, concorrência e construção de APIs.
...
- funcionalidades ligadas a assistentes e agentes com IA;
- melhoria de fluxos internos e experiência do usuário;
...
class DevStack {
  ...
  focus = ["IA aplicada", "APIs", "integrações", "arquitetura", "performance"];
  studying = ["Go"];
}
```
